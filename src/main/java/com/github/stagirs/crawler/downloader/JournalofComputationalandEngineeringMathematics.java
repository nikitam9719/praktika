 ...
 */
@Component
public class JournalofComputationalandEngineeringMathematics extends Downloader {
    @Override
    public String getName() {
        return "Journal of Computational and Engineering Mathematics";
    }

    @Override
    public  String getUrl() {
        return "http://jcem.susu.ru/jcem/issue/archive";
    }
    @Override
    ...
    protected Record getRecord(String url) throws IOException {
        ...
        record.setSource("Южно-Уральский государственный университет. ");
