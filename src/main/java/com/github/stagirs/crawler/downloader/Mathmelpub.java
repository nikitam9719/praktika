 ...
 */
@Component
public class Mathmelpub extends Downloader  {
    @Override
    public String getName() {
        return "Математика и математическое моделирование";
    }

    @Override
    public String getUrl() {
        return "http://www.mathmelpub.ru/jour/issue/archive";
    }
    @Override
    ...
    protected Record getRecord(String url) throws IOException {
        ...
        record.setSource("МГТУ им. Н.Э.Баумана");
...
//
//        Mathmelpub ispRasWorks = new Mathmelpub();
//        System.out.println(Mathmelpub.getAvailableReleases());
//       //System.out.println(releaseDownload("Том 6, № 4 (2017)"));
//    }
}
